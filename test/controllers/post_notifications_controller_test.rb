...
class PostNotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_notification" do
    assert_difference('PostNotification.count') do
      post post_notifications_url, params: { post_notification: { post_id: @post_notification.post_id, seen: @post_notification.seen } }
    end
  ...
  test "should update post_notification" do
    patch post_notification_url(@post_notification), params: { post_notification: { post_id: @post_notification.post_id, seen: @post_notification.seen } }
