...
class UsersController < ApplicationController
  ...
  def user_params
    params.require(:user).permit(:surname, :firstname, :phone, :grad_year, :jobs, :email,:show_notifications, user_detail_attributes: [:id, :password, :password_confirmation, :login])
  end
end
